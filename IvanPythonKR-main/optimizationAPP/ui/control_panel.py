...
class ControlPanelWidget(QWidget):
    ...
    def _build_ui(self) -> None:
        ...
        self.label_function_preview.setTextFormat(Qt.TextFormat.RichText)
        ...
        buttons_row.setContentsMargins(MARGIN // 2, SPACING, MARGIN // 2, 0)
    ...
    def _update_function_preview(self, index: int) -> None:
        ...
        if latex:
            self.label_function_preview.setText(latex)
        else:
